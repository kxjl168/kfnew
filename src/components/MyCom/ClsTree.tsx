...
import { query, add, getTree, get } from '../../pages/KgClassList/service';
...
const Comp: React.FC<TreeProps> = (props, ref) => {
    ...
    const { OnTreeNodeClick, showNodeAction, OnTreeNodeAddNewClsClick, OnSubKgIdChange, OnTreeNodeDeleteClsClick, OnTreeNodeModifyClsClick, OnTreeNodeModifyRelationClick, OnTreeMergeClick } = props;
            ...
            <div className="treemenu" style={tmpStyle} onMouseLeave={hideRight}>
                <>
                    ...
                    <a href="javascript:void(0)" title="" onClick={
                        ...
                        <IconFontNew type="icon-btn-add" title="新增子概念" />新增子概念
                    </a>
                    <Divider type="horizontal" />
                    ...
                    <a href="javascript:void(0)" title="" onClick={
                        ...
                        <IconFontNew type="icon-btn-edit" title="编辑概念" />编辑概念
                    </a>
                    <Divider type="horizontal" />
                    ...
                    <a href="javascript:void(0)" title="" onClick={
                        ...
                        <IconFontNew type="icon-btn-edit" title="合并概念" />合并概念
                    </a>
                    <Divider type="horizontal" />
                    ...
                    >
                        <a href="#" title="">
                            <IconFontNew type="icon-btn-delete" title="删除概念" />删除概念
                        </a>
                    </Popconfirm>
                    ...
                    <div ><Popover trigger="click" placement="right" content={
                        <>
                            ...
                            <a href="#" title="" onClick={
                                ...
                                <IconFontNew type="icon-btn-add" title="新增子概念" />
                            </a>
                            <Divider type="vertical" />
                            ...
                            >
                                <a href="#" title="">
                                    <IconFontNew type="icon-btn-delete" title="删除概念" />
                                </a>
                            </Popconfirm>
                            <Divider type="vertical" />

                        </>
                    }> {clsData.clsName} </Popover></div>
                </>
            )


        return <><span > {clsData.clsName} </span></>
    }
    ...
    const loadNodeData = async (key: string) => {
        ...
        fetch(key, data => {
            ...
            if (data && data.data) {
                ...
                // title: <span ><Popover placement="right" content={getItemActionContent(item)}> {item.clsName} </Popover></span>,
                data.data.map(item => {
                    child.push({
                        title: item.clsName,// getItemActionContent(item),
    ...
    const fetch = (iputval, callback) => {
        SetFetching(true);
        let querydata = { dirId: subIdRef.current ? subIdRef.current.key : "" };
        if (iputval)
    ...
    return (
      ...
      <>
            ...
            <div className="treeQuery">
                ...
                <SubGraSelect className="width100" labelInValue={true} value={subId} onChange={(v) => {
                    setSubId(v)
                    if (OnSubKgIdChange)
