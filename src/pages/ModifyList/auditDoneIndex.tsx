...
import { get, listAuditDone as query, update, add, remove } from './service';
  ...
  return (
   ...
   // editAction: 2,// varchar(2) comment '编辑操作类型 1:新增，2:修改， 3:删除'
    ...
    },
    {
      ...
      valueEnum:{
        "3": { text: '通过', status: 'Success' },
        "4": { text: '合并通过', status: 'Success' },
        "5": { text: '不通过', status: 'Error' },
      },
      rules: [
        {
          required: false,
...
<>
          ...
          >
                 <Tooltip title="审核详情">
            <IconFontNew type="icon-detail" title="" />
            </Tooltip>
          </a>
            ...
            <Dropdown
              overlay={
                <Menu
                  ...
                  selectedKeys={[]}
                >
                  <Menu.Item key="remove">撤销删除</Menu.Item>
                  <Menu.Item key="audit">提交审核</Menu.Item>
...
<AuditForm modelvalue={modelvalue} readonly   dataType={stepFormValues.dataType} modalVisible={updateModalVisible} onCancel={
        () => {
