...
const urlpre:string = "/kb/kg/kg-relation";
...
const listattrfun:string="/listattrs";
...
export async function listattrs(params?: TableListItem) {

  return request(urlpre + listattrfun, {
    method: 'POST',
